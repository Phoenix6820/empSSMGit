...
<body>
	...
	<div id="main">
		<form action="searchLazy.do" class="form-horizontal" role="form" method="post">
				...
				<c:forEach items="${list}" var="emp">
					...
					<tr data-id="${emp.id }">
						...
						<td><c:if test="${not empty emp.photo }">
								<img src="<%=request.getContextPath() %>/pic/${emp.photo}" />
							</c:if></td>
					</tr>
				</c:forEach>
			</tbody>
		...
		<ul class="pagination">
			<li><a
				href="search.do?ye=1&name=${c.name}&sex=${c.sex}&age=${c.age!=-1?c.age:''}&dep.id=${c.dep.id }">首页</a></li>
			<li id="pre"><a
				href="search.do?ye=${p.ye-1}&name=${c.name}&sex=${c.sex}&age=${c.age!=-1?c.age:''}&dep.id=${c.dep.id }">上一页</a></li>
			...
			<li id="next"><a
				href="search.do?ye=${p.ye+1}&name=${c.name}&sex=${c.sex}&age=${c.age!=-1?c.age:''}&dep.id=${c.dep.id }">下一页</a></li>
			<li><a
				href="search.do?ye=${p.maxYe}&name=${c.name}&sex=${c.sex}&age=${c.age!=-1?c.age:''}&dep.id=${c.dep.id }">尾页</a></li>
		</ul>
		<div>
